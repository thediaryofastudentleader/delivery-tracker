...
export default function SpinWheel({ cpcCode, orderTotal, dark, onPrize }) {
  ...
  useEffect(() => {
    const check = () => {
      const now = new Date();
      const day = now.getDay(); // 2=Tue, 5=Fri
      const hour = now.getHours();
      const isTueOrFri = day === 2 || day === 5;
      const isAfternoonEvening = hour >= 12 && hour < 22;
      if (!isTueOrFri || !isAfternoonEvening || !cpcCode) {
        setCanSpin(false);
        return;
      }
  ...
  if (!isTueOrFri || !isAfternoonEvening) {
    return (
      <div style={{
        ...
        🎰 Spin & Win available Tue/Fri 12PM-10PM
      </div>
    );
  }
    ...
    <div style={{ marginBottom: 20 }}>
      ...
      {showWheel && (
        <div style={{
          ...
          padding: 20, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)'
        }}>
          <div style={{
            ...
            <div style={{ position: 'relative', width: 280, height: 280, margin: '0 auto 20px' }}>
              ...
              <div style={{
                ...
                borderTop: '20px solid #ef4444', zIndex: 10
              }} />
              <div style={{
                position: 'absolute', top: '50%', left: '50%',
            ...
            {result && (
              <div style={{
                ...
                background: result.color + '20', color: result.color, fontWeight: 700
              }}>
